  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-start text-center px-6 pt-32">
      <motion.div
        ...
        transition={{ duration: 0.4 }} // Reduziert auf 0.4
      >
        <img 
      ...
      <motion.h1
        ...
        transition={{ duration: 0.5 }} // Reduziert auf 0.5
      >
        Simon Bermadinger
      </motion.h1>
      ...
      <motion.p
        ...
        animate={{ opacity: 1, y: 0 }}
        // Verzögerung (delay) entfernt, Dauer verkürzt
      ...
      <div className="mt-6 flex space-x-4">
        <motion.a
          ...
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.3 }} // Keine Verzögerung, kürzere Dauer
        >
          📄 Resume
        </motion.a>
        <motion.a
