      ...
      <section className="max-w-3xl mx-auto py-12 sm:py-24 text-center">
        ...
        <div className="relative z-10 mt-8">
          <a
            ...
            className="inline-flex items-center gap-2 bg-primaryColor text-white px-8 py-3 rounded-full bg-black text-base hover:bg-primary-dark transition-all duration-300 ease-in-out"
          >
            Visit Site
            <svg
